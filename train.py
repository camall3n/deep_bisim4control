...
def parse_args():
    ...
    parser.add_argument('--encoder_lr', default=0.001, type=float)
    ...
    parser.add_argument('--tag', default='default_experiment', type=str)
    parser.add_argument('--save_tb', default=False, action='store_true')
    parser.add_argument('--save_model', default=False, action='store_true')
    parser.add_argument('--save_buffer', default=False, action='store_true')
    parser.add_argument('--save_video', default=False, action='store_true')
    parser.add_argument('--transition_model_type', default='ensemble', type=str, choices=['', 'deterministic', 'probabilistic', 'ensemble'])
